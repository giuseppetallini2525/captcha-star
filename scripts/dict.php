<?php
/**
 * Importa vettori GloVe 50d nel database
 * Esegui da CLI: php dict.php
 */
set_time_limit(0);
...
$file = fopen(__DIR__ . "/../data/embeddings/50d/wiki_giga_2024_50_MFT20_vectors_seed_123_alpha_0.75_eta_0.075_combined.txt",'r') or die("unable to open GloVe file\n");

// Prepara statement
$stmt = $conn->prepare("INSERT INTO dizionario_50(parola, vettore, idf) VALUES(?, ?, 0)");
